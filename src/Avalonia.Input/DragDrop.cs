...
namespace Avalonia.Input
{
    public static class DragDrop
    {
        ...
        public static readonly DependencyProperty<bool> AllowDropProperty = DependencyProperty.RegisterAttached<Interactive, bool>("AllowDrop", typeof(DragDrop), inherits: true);
