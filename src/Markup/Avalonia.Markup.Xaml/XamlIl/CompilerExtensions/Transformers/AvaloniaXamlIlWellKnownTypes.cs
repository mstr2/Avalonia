...
namespace Avalonia.Markup.Xaml.XamlIl.CompilerExtensions.Transformers
{
    class AvaloniaXamlIlWellKnownTypes
    {
        ...
        public IXamlIlType DependencyProperty { get; }
        public IXamlIlType DependencyPropertyT { get; }
        ...
        public AvaloniaXamlIlWellKnownTypes(XamlIlAstTransformationContext ctx)
        {
            ...
            DependencyProperty = ctx.Configuration.TypeSystem.GetType("Avalonia.DependencyProperty");
            DependencyPropertyT = ctx.Configuration.TypeSystem.GetType("Avalonia.DependencyProperty`1");
            ...
            AvaloniaObjectSetValueMethod = AvaloniaObject.FindMethod("SetValue", XamlIlTypes.Void,
                false, DependencyProperty, XamlIlTypes.Object, BindingPriority);
