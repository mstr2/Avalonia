...
namespace Avalonia.Controls
{
    ...
    public class RowDefinition : DefinitionBase
    {
        ...
        public static readonly StyledProperty<double> MaxHeightProperty =
            DependencyProperty.Register<RowDefinition, double>(nameof(MaxHeight), double.PositiveInfinity);

        /// <summary>
        /// Defines the <see cref="MinHeight"/> property.
        /// </summary>
        public static readonly StyledProperty<double> MinHeightProperty =
            DependencyProperty.Register<RowDefinition, double>(nameof(MinHeight));

        /// <summary>
        /// Defines the <see cref="Height"/> property.
        /// </summary>
        public static readonly StyledProperty<GridLength> HeightProperty =
            DependencyProperty.Register<RowDefinition, GridLength>(nameof(Height), new GridLength(1, GridUnitType.Star));
